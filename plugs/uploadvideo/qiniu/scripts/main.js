...
$(function() {
  var uploader = Qiniu.uploader({
    ...
    init: {
      ...
      'FileUploaded': function(up, file, info) {
        ...
        var str = GV.domain_bucket+res.key+','+ GV.domain_bucket+'nUyP59nq1hJe-8iSZV9huoGHk8Y=/'+res.hash;
        $("#video_upload").val(str);
      },
  ...
  $('#myModal-img .modal-body-footer').find('a').on('click', function() {
    ...
    img.attr('src', GV.plugPath+'/qiniu/images/loading.gif');
